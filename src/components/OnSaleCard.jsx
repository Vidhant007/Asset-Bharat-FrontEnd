  ...
  return (
    <div className="relative max-w-sm rounded-lg bg-custom-blue">
      ...
      <div className="p-5 text-white">
        ...
        <Link to={`/property/sale`} className="md:absolute md:right-5 md:bottom-5 inline-flex items-center px-3 py-2 text-sm text-center text-white bg-blue-400 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          View Details
