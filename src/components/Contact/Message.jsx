      ...
      <div className='bg-blue-xlight text-black md:flex items-center justify-evenly p-20'>
        <div className="md:inline-block mb-4 md:mb-0">
          <section className='text-custom-blue flex flex-col gap-12'>
            <h1 className="text-3xl md:text-6xl leading-7 sm:text-6xl sm:tracking-tight">
              SEND US A <br /> MESSAGE
            </h1>
            <p className='text-sm font-jost md:w-100'>
        ...
        <div className="md:inline-block">
          <form className='flex flex-col gap-5 font-jost' onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <input type="text" placeholder='Your name' className="block bg-white md:w-96 w-full p-2" value={formData.name} onChange={handleChange} name="name" />
            </div>

            <div className="mb-3">
              <label htmlFor='lastName' className="block text-black">Last name</label>
              <input type="text" placeholder='Your last name' className="bg-white block md:w-96 w-full p-2" value={formData.lastName} onChange={handleChange} name="lastName" />
            </div>

            <div className="mb-3">
              <label htmlFor='email' className="block text-black">Your email*</label>
              <input type="text" placeholder='Your email address' className="bg-white block md:w-96 w-full p-2" value={formData.email} onChange={handleChange} name="email" />
            </div>

            <div className="mb-3">
              <label htmlFor='message' className="block text-black">Message*</label>
              <textarea type="text" placeholder='Enter your message' className="bg-white block md:w-96 w-full p-2" value={formData.message} onChange={handleChange} name="message" />
            </div>
