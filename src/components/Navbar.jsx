    ...
    <div className='font-krona'>
      <div className='w-full fixed top-0 bg-custom-blue text-white font-krona z-50'>
        <div className='flex  justify-between pt-6 pb-6 pr-12 md:justify-center'>
          <div className='pr-12'>
            <Link to="/">
              <img src={assetLogo} className='h-16 pl-7 md:pl-1' alt="Logo" />
            </Link>
          </div>
          <div className="relative" ref={dropdownRef}>
            <button
              className={`md:hidden py-4 transition-transform duration-300 transform ${dropDown ? 'rotate-180' : 'rotate-0'
                }`}
            ...
            <nav
              className={`absolute right-0 top-14 mt-2 w-44 truncate bg-custom-blue text-white font-krona border border-gray-300 rounded-lg shadow-lg overflow-hidden ${dropDown ? 'opacity-100 scale-100' : 'opacity-0 scale-0'
                } transition-all duration-300 transform origin-top md:hidden`}
            >
              <Link to="/about-us" className='block p-4 transition duration-300 hover:bg-gray-800' onClick={toggleDropDown}>About us</Link>
              <Link to="/projects" className='block p-4 transition duration-300 hover:bg-gray-800' onClick={toggleDropDown}>Projects</Link>
              <Link to="/why-us" className='block p-4 transition duration-300 hover:bg-gray-800' onClick={toggleDropDown}>Why Us?</Link>
              ...
              {signedIn ? (
                ...
                <Link to="/signup" className='block p-4 transition duration-300 hover:bg-gray-800' onClick={toggleDropDown}>
                  Sign up
                </Link>
              )}
            </nav>
