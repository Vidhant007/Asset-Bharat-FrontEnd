    ...
    <div className="flex flex-col bg-cream-bg text-custom-blue p-4 md:p-10 pt-10 md:pt-20 pb-10 md:pb-20 items-center">
      {data ? (
        <div className='flex justify-center items-center gap-5'>
          <h1 className="text-2xl md:text-4xl lg:text-5xl text-left pb-5 pt-20 md:pb-10">Renonsance Cascade</h1>
      ...
      {data && data.highlightedImages.length > 0 && (
        ...
        <img
          ...
          src={img1}
          alt="Image"
          className={`object-cover ${currentImageIndex === 0 ? 'block' : 'hidden'}`}
