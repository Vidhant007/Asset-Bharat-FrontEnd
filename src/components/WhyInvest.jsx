...
const WhyInvest = () => {
  ...
  return (
    <div className='bg-custom-blue '>
      <div className='flex flex-col items-center gap-10 justify-center pr-100 p-10 '>
          <h2 className='text-4xl font-krona'>WHY INVEST IN COMMERICIAL ESTATE</h2>
          <h4 className='text-lg pr-85 pt-10'>Other Investments vs Commericial RealEstate (CRE)</h4>
      </div>
